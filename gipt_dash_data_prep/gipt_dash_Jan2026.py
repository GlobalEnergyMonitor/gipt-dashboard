...
gipt=pandas.read_excel('./Global Integrated Power January 2026.xlsx',sheet_name='Power facilities')
...
tmp.to_json("./public/assets/data/gipt_data_ticker_jan2026.json", orient="records", indent=2, force_ascii=False)
...
json_output_path = "./public/assets/data/operating_plants_map_jan2026_30k.json"
...
df_cleaned.to_csv('C:/Users/james/Documents/GitHub/gipt-dashboard/public/assets/data/GEM_capacity_stacked_jan2026.csv',encoding='utf-8-sig')

# Pretty-printed JSON
df_cleaned.to_json("C:/Users/james/Documents/GitHub/gipt-dashboard/public/assets/data/GEM_capacity_stacked_jan2026.json", orient="records", indent=2, force_ascii=False)
...
df_full.sort_values(by=['Country', 'Year']).fillna(0.).to_csv("./public/assets/data/net_capacity_jan2026.csv",index=False,encoding='utf-8-sig')

# Pretty-printed JSON
df_full.to_json("./public/assets/data/net_capacity_jan2026.json", orient="records", indent=2, force_ascii=False)
...
tmp.to_json("./public/assets/data//gipt_development_jan2026.json", orient="records", indent=2, force_ascii=False)
tmp.fillna(0.).to_csv("./public/assets/data//gipt_dev_jan2026.csv",encoding='utf-8-sig')
...
tmp.to_json("./public/assets/data/gipt_fossil_nonfossil_jan2026.json", orient="records", indent=2, force_ascii=False)
...
tmp.fillna(0.).to_csv("./public/assets/data/gipt_share_jan2026.csv",encoding='utf-8-sig')
...
final_df_sorted.to_csv('./public/assets/data/age_breakdown_jan2026.csv',index=False,encoding='utf-8-sig')

# Pretty-printed JSON
final_df_sorted.to_json("./public/assets/data/age_breakdown_jan2026.json", orient="records", indent=2, force_ascii=False)
...
sorted_df.columns=['Country','Parent(s)', 'Capacity (GW)', 'Type']
sorted_df[['Country','Parent(s)', 'Capacity (GW)', 'Type']].to_csv('./public/assets/data/ownership_jan2026.csv',encoding='utf-8-sig', index=False)

# Pretty-printed JSON
sorted_df.to_json("./public/assets/data/ownership_jan2026.json", orient="records", indent=2, force_ascii=False)
