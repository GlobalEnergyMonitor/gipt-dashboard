...
gipt=pandas.read_excel('./Global Integrated Power February 2026 II.xlsx',sheet_name='Power facilities')
...
df_file="C:/Users/james/Documents/GEM/GIPT/February 2026 II (GSPT+GWPT) update/Global-Solar-Power-Tracker-February-2026.xlsx"
...
tmp.to_json("./public/assets/data/gipt_data_ticker_febII2026.json", orient="records", indent=2, force_ascii=False)
...
json_output_path = "./public/assets/data/operating_plants_map_feb2026_30k.json"
...
df_cleaned.to_csv('C:/Users/james/Documents/GitHub/gipt-dashboard/public/assets/data/GEM_capacity_stacked_febII2026.csv',encoding='utf-8-sig')

# Pretty-printed JSON
df_cleaned.to_json("C:/Users/james/Documents/GitHub/gipt-dashboard/public/assets/data/GEM_capacity_stacked_febII2026.json", orient="records", indent=2, force_ascii=False)
...
df_full.sort_values(by=['Country', 'Year']).fillna(0.).to_csv("./public/assets/data/net_capacity_febII2026.csv",index=False,encoding='utf-8-sig')

# Pretty-printed JSON
df_full.to_json("./public/assets/data/net_capacity_febII2026.json", orient="records", indent=2, force_ascii=False)
...
tmp.to_json("./public/assets/data//gipt_development_febII2026.json", orient="records", indent=2, force_ascii=False)
tmp.fillna(0.).to_csv("./public/assets/data//gipt_dev_febII2026.csv",encoding='utf-8-sig')
...
tmp.to_json("./public/assets/data/gipt_fossil_nonfossil_febII2026.json", orient="records", indent=2, force_ascii=False)
...
tmp.fillna(0.).to_csv("./public/assets/data/gipt_share_febII2026.csv",encoding='utf-8-sig')
...
final_df_sorted.to_csv('./public/assets/data/age_breakdown_febII2026.csv',index=False,encoding='utf-8-sig')

# Pretty-printed JSON
final_df_sorted.to_json("./public/assets/data/age_breakdown_febII2026.json", orient="records", indent=2, force_ascii=False)
...
sorted_df[['Country','Parent', 'Capacity (GW)', 'Type']].to_csv('./public/assets/data/ownership_febII2026.csv',encoding='utf-8-sig', index=False)

# Pretty-printed JSON
sorted_df.to_json("./public/assets/data/ownership_febII2026.json", orient="records", indent=2, force_ascii=False)
